<script>
  ...
  const speakers = [
    ...
    {
      name: "Robert Hall",
      title: "Svelte: the Story Engineer’s Ideal Framework",
      blurb:
    ...
    },
    {
      ...
      title: "How To Do Basically Everything In Svelte",
      blurb:
        "A walkthrough of the 5 most common design patterns for Svelte apps, giving you a guided tour of Svelte's greatest features.",
